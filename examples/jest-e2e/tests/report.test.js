...
// Live E2E harness for the jest-reporter.
//
...
// The reporter (wired in jest.config.js) then submits this test's result to the live run; the
...
const maybe = ciKey ? test : test.skip;

maybe('reports a seeded automated result to a live NoHotfix run', () => {
